...
class StMuDst;
class StMuEvent;
class StMuDstMaker; //# Added by jcampbell
...
public:
  ...
  void          SetMuDstMaker(StMuDstMaker* muDstMaker); //# Added by jcampbell
...
private:
  ...
  StMuDstMaker*    pMuDstMaker;               //! pointer to Mu-DST maker //# added by jcampbell
...
//# Added by jcampbell
inline void StFlowMaker::SetMuDstMaker(StMuDstMaker* muDstMaker) {
  pMuDstMaker = muDstMaker; }
