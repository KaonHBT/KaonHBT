...
inline Float_t Track::GetBeta() const { return mBeta; }
inline void Track::SetBeta(Float_t beta) { mBeta = beta; }

inline Int_t Track::GetTrackType() const {return mTrackType;}
inline void Track::SetTrackType(Int_t tracktype) {mTrackType = tracktype;}
