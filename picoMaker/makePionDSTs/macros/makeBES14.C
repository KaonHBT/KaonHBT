...
void makeBES14(const TString fileList = "test200.list"
				...
				)
{
    ...
    Float_t VrCut = 1.;                // Cut on r-vertex
    Float_t VrCenter[2] = {0.,-0.89};        // Beam center - (0, -0.89) for 14.6 GeV
    Float_t etaGap = 10;
    Float_t triggers[2] = {440005, 440015}; 
    Int_t nTriggers = 2;
