...
#define FSICONS COMMON_BLOCK(FSI_CONS,fsi_cons)
COMMON_BLOCK_DEF(FSICONSCommon, FSI_CONS);
//----------------------------------------------------------------
...
#define FSINS COMMON_BLOCK(FSI_NS,fsi_ns)                                  
COMMON_BLOCK_DEF(FSINSCommon, FSI_NS);                               
...
#define FSIPOC COMMON_BLOCK(FSI_POC, fsi_poc)                                  
COMMON_BLOCK_DEF(FSIPOCCommon, FSI_POC);                               
...
#define FSIMOM COMMON_BLOCK(FSI_MOM,fsi_mom)                                  
COMMON_BLOCK_DEF(FSIMOMCommon, FSI_MOM);                               
...
#define FSICOOR COMMON_BLOCK(FSI_COOR,fsi_coor)                               
COMMON_BLOCK_DEF(FSICOORCommon, FSI_COOR);                             
...
#define FSIPRF COMMON_BLOCK(FSI_PRF,fsi_prf)                                         
COMMON_BLOCK_DEF(FSIPRFCommon, FSI_PRF);                                      
