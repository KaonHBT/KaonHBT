...
// -----------------------------
// From now on
//  - the fit points used in myflowmaker are the fit points within the TPC xor FTPC (vertex excluded).
...
// First check in of myflowmaker. It contains the common code from
// StFlowTagMaker and myflowanalysismaker.
//
//////////////////////////////////////////////////////////////////////
