...
// Description:  Macro to plot histograms made by myflowanalysismaker.
...
TCanvas* plotCen(Int_t pageNumber=0, Int_t selN=2, Int_t harN=2){
  ...
  // names of histograms made by myflowanalysismaker
...
// myflowmaker StFlowEvent::PhiWeight() changes.
